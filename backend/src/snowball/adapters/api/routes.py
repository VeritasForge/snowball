...
def update_account(
    ...
    if existing.user_id != current_user.id:
        raise HTTPException(HTTPStatus.FORBIDDEN, "Not authorized to update this account")
...
def delete_account(
    ...
    if existing.user_id != current_user.id:
        raise HTTPException(HTTPStatus.FORBIDDEN, "Not authorized to delete this account")
...
def create_asset(
    ...
    if account.user_id != current_user.id:
        raise HTTPException(HTTPStatus.FORBIDDEN, "Not authorized to add asset to this account")
...
def update_asset(
    ...
    if not account or account.user_id != current_user.id:
        raise HTTPException(HTTPStatus.FORBIDDEN, "Not authorized to update this asset")
...
def execute_trade(
    ...
    account = account_repo.get(asset.account_id)
    if not account or account.user_id != current_user.id:
        raise HTTPException(HTTPStatus.FORBIDDEN, "Not authorized to trade this asset")
